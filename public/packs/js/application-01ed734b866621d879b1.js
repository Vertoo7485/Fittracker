...
/*!
  ...
  */
(function (global, factory) {
   true ? module.exports = factory(__webpack_require__(/*! ../util/index.js */ "./node_modules/bootstrap/js/dist/util/index.js")) : undefined;
  ...
  function removeNamespacedHandlers(element, events, typeEvent, namespace) {
    ...
    for (const _ref of Object.entries(storeElementEvent)) {
      var _ref2 = _slicedToArray(_ref, 2);
      const handlerKey = _ref2[0];
      const event = _ref2[1];
  ...
  const EventHandler = {
    ...
    off(element, originalTypeEvent, handler, delegationFunction) {
      ...
      for (const _ref3 of Object.entries(storeElementEvent)) {
        var _ref4 = _slicedToArray(_ref3, 2);
        const keyHandlers = _ref4[0];
        const event = _ref4[1];
  ...
  function hydrateObj(obj) {
    ...
    for (const _ref5 of Object.entries(meta)) {
...
/*!
  ...
  */
(function (global, factory) {
   true ? module.exports = factory(__webpack_require__(/*! ../dom/manipulator.js */ "./node_modules/bootstrap/js/dist/dom/manipulator.js"), __webpack_require__(/*! ./index.js */ "./node_modules/bootstrap/js/dist/util/index.js")) : undefined;
  ...
  class Config {
    ...
    _mergeConfigObj(config, element) {
      ...
      return _objectSpread(_objectSpread(_objectSpread(_objectSpread({}, this.constructor.Default), typeof jsonConfig === 'object' ? jsonConfig : {}), index_js.isElement(element) ? Manipulator.getDataAttributes(element) : {}), typeof config === 'object' ? config : {});
    }
    _typeCheckConfig(config) {
      let configTypes = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : this.constructor.DefaultType;
      for (const _ref of Object.entries(configTypes)) {
        var _ref2 = _slicedToArray(_ref, 2);
        const property = _ref2[0];
        const expectedTypes = _ref2[1];
...
/******/ });
//# sourceMappingURL=application-01ed734b866621d879b1.js.map